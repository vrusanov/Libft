SRC	=	ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c\
		...
		ft_memchr.c ft_memcmp.c ft_memdel.c ft_memcpy.c ft_memmove.c\
		...
		ft_lstiter.c ft_lstmap.c get_next_line.c ft_isspace.c ft_atol_base.c

NAME		=	libft.a

CC		=	gcc

GLAS	=	-Wall -Wextra -Werror -I libft.h
